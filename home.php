...
<section class="section">
  ...
  <div class="centered-content">
    <a href="#login" class="login-btn btn">Get Started Now!</a>
  </div>
</section>
<section class="section">
  <h3>For Parents</h3>
...
<section class="section dark">
  ...
  <div class="cards">
    <div class="card">
      <i class="fas fa-wrench"></i>
      <div class="content">
        <h5>Cheaper Transfers</h5>
        <p>Most transactions only cost 0.000042 GO -- meaning a single GO token can fund 10s of thousands of transactions.</p>
      </div>
    </div>
    <div class="card">
      <i class="fas fa-mobile"></i>
  ...
  <div class="centered-content">
    <a href="http://www.gochain.io" target="_blank" class="white btn">Learn More About GoChain</a> <a href="https://www.binance.com/?ref=12087050" target="_blank" class="white hot btn">Buy GO Tokens</a>
  </div>
</section>
<section class="section">
  ...
  <div class="centered-content">
    <a href="" class="login-btn btn">Get Started Today</a>
  </div>
</section>